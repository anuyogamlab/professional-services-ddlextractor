#!/bin/bash
#
# Create a Persistent History Server (PHS) on Dataproc 2.x
# To setup Persistent History Server (PHS) on Dataproc 1.5, modify --image-version 
...
# Create PHS pointing to the GCS_BUCKET
